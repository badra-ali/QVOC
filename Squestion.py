...
def display_audit_form():
    ...
    sections = {
        "Section 1 : Etiquetage et Information au consommateur  Les contrôles effectués par COTECNA relativement à l’étiquetage du produit tiennent-ils compte des mentions obligatoires visibles et lisibles suivantes":[
